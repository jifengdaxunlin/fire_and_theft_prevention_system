...
// 8x8 ASCII 全字模 (ASCII 32 ~ 126)
static const uint8_t ascii_font_8x8[][8] = {
    ...
    {0x02, 0x04, 0x08, 0x10, 0x20, 0x00, 0x00, 0x00}, // \ (反斜杠)
...
// 5x8 日期时间专用紧凑字模
static const uint8_t font_5x8_dateTime[][5] = {
    /* ' ' (0) */ {0x00, 0x00, 0x00, 0x00, 0x00},
    /* '-' (1) */ {0x08, 0x08, 0x08, 0x08, 0x08},
    /* ':' (2) */ {0x00, 0x36, 0x36, 0x00, 0x00},
    /* '0' (3) */ {0x3E, 0x51, 0x49, 0x45, 0x3E},
    /* '1' (4) */ {0x00, 0x42, 0x7F, 0x40, 0x00},
    /* '2' (5) */ {0x42, 0x61, 0x51, 0x49, 0x46},
    /* '3' (6) */ {0x21, 0x41, 0x45, 0x4B, 0x31},
    /* '4' (7) */ {0x18, 0x14, 0x12, 0x7F, 0x10},
    /* '5' (8) */ {0x27, 0x45, 0x45, 0x45, 0x39},
    /* '6' (9) */ {0x3C, 0x4A, 0x49, 0x49, 0x30},
    /* '7' (10)*/ {0x01, 0x71, 0x09, 0x05, 0x03},
    /* '8' (11)*/ {0x36, 0x49, 0x49, 0x49, 0x36},
    /* '9' (12)*/ {0x06, 0x49, 0x49, 0x29, 0x1E}
};

/**
  * @brief  将 ASCII 字符安全转换为 5x8 时间字库的索引
  */
static inline uint8_t OLED_GetFont5x8Index(char ch) {
    if (ch >= '0' && ch <= '9') {
        return (ch - '0') + 3;
    } else if (ch == '-') {
        return 1;
